 ...
 */
 ...
 NOTE: Amount Due is already calculated in RentCar so in this we just take value from the database and display it to the customer.
...
public class ReturnCar extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtRentID, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
          ...
          pstmt=conn.prepareStatement("Select amount_due from rentals where Rent_ID=?;");
          pstmt.setInt(1,RentID);
          rs=pstmt.executeQuery();
          while(rs.next())
          {
              Amount=rs.getInt("amount_due");
          }
        }
        catch(Exception e)
        {
        ...
        if(Amount>0)
        {
             JOptionPane.showMessageDialog(null,"Thank You For Using Our Service. Your Amount Due is Rs."+Amount+" ");
        }
        else
        {
             JOptionPane.showMessageDialog(null,"Invalid RentID");
        }
